...
public class DownloadInvoiceTest {
    ...
    @Given("Use browser {string} and Navigate to  {string}")
    public void useBrowserAndNavigateTo(String browser, String url) {
    ...
    @And("Verify that Homepage is visible successfully")
