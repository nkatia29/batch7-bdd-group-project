...
public class RegisterUserSteps {
    ...
    public void click_on_SignupLogin_button() throws InterruptedException {
    ...
    public void verifyThatLoggedInAsRegisteredNameIsVisible() {
        userPage.verifyThatLoggedInAsUsernameIsVisible();
